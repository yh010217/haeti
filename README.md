...
|[김보경](https://github.com/ppodaejang)|[은별](https://github.com/Agstarr)|[최용훈](https://github.com/yh010217)|[홍유나](https://github.com/yuyuyu1123)|
|-----------------------------|------------------------------------|--------------------------------------|-----------------------------------|
| 팀장 <br> 상품구매<br> 관리자페이지 | 마이페이지 | 상품판매 <br> 채팅 | 회원가입 <br> 로그인 |


## 기획의도
+ 교육 관련 자료를 효율적으로 거래할 수 있는 공간을 마련하여 교육 현장에서 필요한 물품을 가까운 곳에서 빠르게 거래 할 수 있도록 동네 기반의 중고 직거래 플랫폼 제작
+ 같은 직업군 내에서 거래를 함으로써 필요한 자료의 가치와 경험 공유가 가능
+ 사용자가 물품을 직접 확인하고 거래를 완료하도록 하여 사기 발생 가능성을 최소화 
...
### 메인페이지
![haeti_index](https://github.com/yh010217/haeti/assets/160826598/78684606-8458-4f72-86d5-e67f5801c27e)
- 전체매물/거리별/출판사별/관심지역의 매물 목록을 확인
- 관심지역의 상품을 지도와 함께 확인 할 수 있는 매물지도 구현
- 페이지 상단에 검색메뉴를 고정하여 매물 이름으로 조회
...
### 상품기능
1. 상품 등록 및 수정,삭제
- 이미지 등록 및 제목, 내용 가격 설정 후 작성 완료
- 한 개 이상의 이미지에는 개수에 맞는 슬라이더 구현
![해티-글작성](https://github.com/yh010217/haeti/assets/57435446/aceeba20-73c8-4572-987e-e34adccfeec5)
2. 채팅 기능
- 구매 희망자와 판매자의 채팅 기능, 채팅 내역은 DB에 저장
- 웹소켓을 통한 실시간 채팅 기능 구현
![채팅-편집](https://github.com/yh010217/haeti/assets/57435446/5e49ff60-4d72-464d-a80c-c4c73f86b02e)
### 마이페이지
1. 마이페이지
![해티_마이페이지_gif](https://github.com/yh010217/haeti/assets/160826886/260e7e33-defe-4651-8390-c302ffdb44b1)
- 판매 내역 판매 상태별 조회 기능 구현
- 구매 내역 기간별 조회 기능 구현
- 내 정보 수정 기능 구현
  
### 관리자페이지
![haeti_admin](https://github.com/yh010217/haeti/assets/160826598/a940f2a5-1ec2-4630-a8cc-ca75eff0d9b4)
- 회원 조회 및 회원 정보 수정 기능 구현
- 상품 조회 및 정보 수정 기능 구현
